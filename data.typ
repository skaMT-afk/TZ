#let data = (
  ...
  project_name: "Написание игры Богровый Псалом",
  // Example: "Learning how to purchase TON"
  project_name_english: "Writing the game Crimson Psalm",
  ...
  students: (
    (name: "Газиев С.И.", group: "БПИ242"),
    (name: "Малахова Д.О.", group: "БПИ246"),
    (name: "Тю М.А.", group: "БПИ246"),
  ),

  // Agreed
  // Example: "П. В. Дуров"
  agreed_by_name: "Штанов Андрей Николаевич",
  // Example: "Основатель социальной сети \"ВКонтакте\" и мессенджера Telegram"
  agreed_by_position: "Штатный преподователь, Департамент программной инженерии",
